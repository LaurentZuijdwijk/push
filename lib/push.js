...
cli.main(function(args, options) {
  var execGit, execTest, getRevision, processArgs;
  ...
  return async.series([async.apply(processArgs), async.apply(execGit, "git pull"), async.apply(execGit, "git add ."), async.apply(execGit, "git status"), async.apply(require('./commit')), async.apply(execGit, "git status"), async.apply(getRevision)]);
});
