...
(function() {
  ...
  cli.main(function(args, options) {
    ...
    tasks = [async.apply(execGit, "git pull"), async.apply(execGit, "git add ."), async.apply(execGit, "git status"), async.apply(require('./commit')), async.apply(execGit, "git status"), async.apply(getRevision)];
    return async.series(tasks, function() {
      return console.log('all done'.yellow.inverse.bold);
    });
  });
