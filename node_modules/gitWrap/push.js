...
async.waterfall([async.apply(processArgs), async.apply(execGit, "git pull"), async.apply(execGit, "git status"), async.apply(execGit, "git add ."), async.apply(execGitCommit), async.apply(execGit, "git status"), async.apply(getRevision)]);
